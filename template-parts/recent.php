...
<?php if( $mosi_options_home_posts_post_type !== 'none' ): ?>
    ...
    if( $mosi_options_home_posts_post_type === 'post' ) {
        $mosi_posts_title = empty( $mosi_posts_title ) ? __( 'Latest Posts', 'mosir' ) : $mosi_posts_title;
        $mosi_posts_subtitle = empty( $mosi_posts_subtitle ) ? __( 'Blog', 'mosir' ) : $mosi_posts_subtitle;
    } else {
    ...
    <div class="p-section<?php echo $mosi_options_home_posts_header === 'left' ? ' p-section--horizontal' : ''; ?>">
        ...
        <div class="p-section__footer">
            <p class="p-section__link"><a href="<?php echo esc_url( $mosi_options_home_posts_link ); ?>"><?php echo esc_html( __( 'View All', 'mosir' ) ); ?></a></p>
        </div>
        <?php endif; ?>
    </div>
