...
= 1.2.1 =
* Improved the drawer / Fixed a bug in the iOS dropdown list / Changed the menu display name to one that is not related to the appearance

= 1.2.0 =
* Reworked header and footer structure / Reduced default line spacing / Added flat vertical navigation / Reduced CSS specificity for body styling
